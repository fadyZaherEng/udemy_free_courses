...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<UdemyCubit,UdemyAppSates>(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                        itemCount: UdemyCubit.get(context).category.length,
                        scrollDirection: Axis.horizontal,
                        itemBuilder: (ctx, int index) {
                          return CategoryTile(
                            imageURL: UdemyCubit.get(context).category[index].imageURL,
                            color: UdemyCubit.get(context).category[index].color,
                            categoryName: UdemyCubit.get(context).category[index].categoryName,
                          );
                        }),
                  ),
                  Container(
                  ...
                  (state is InitialCoursesUdemyAppSates||state is ErrorCourseUdemyAppSates) ?
                  Center(
                    child: Container(
                      child: SpinKitWave(
